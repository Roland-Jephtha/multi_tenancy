    ...
    function k(e, t, i, r) {
        ...
        function a(e, t) {
            ...
            if (a) {
                var n = u;
                for (
                    n.skip ? (p += t) : (n.rE || n.eE || (p += t), s(), n.eE && (p = t)); u.cN && (b += N),
                    u.skip || u.sL || (m += u.r),
                    (u = u.parent) !== a.parent;
            ...
            (v.useBR ?
                    ...
                    (a.value = (function(e, t, r) {
                        ...
                        for (; e.length || t.length;) {
                            ...
                            if (
                                ...
                                for (
                                    i.reverse().forEach(o); l(u.splice(0, 1)[0]),
                ...
                (e.className = (function(e, t, r) {
                    var a = t ? c[t] : r,
                        n = [e.trim()];
                    return (
                        e.match(/\bhljs\b/) || n.push("hljs"), -1 === e.indexOf(a) && n.push(a),
                        n.join(" ").trim()
                    );
